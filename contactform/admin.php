...
class Admin {
    ...
    public static function main(){
        ...
        $csrfTokenRequired = false !== strpos('|validateForm|', "|$method|" );
        if( $csrfTokenRequired ){
            self::exitIfCsrfTokenNotValid();
        };

        $isPublic = false !== strpos('|validateForm|forgotPassword|csrfToken|logout|', "|$method|" );
        if( $isPublic ){
            self::$method();
            exit;
        };
...
?>
        ...
        <input type="hidden" id="externalFormConfig" name="externalFormConfig" value="<?php echo base64_encode( Form::getConfig(false) ); ?>">
